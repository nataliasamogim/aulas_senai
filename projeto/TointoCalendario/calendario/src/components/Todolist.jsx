...
function Todolist() {
    ...
    return (
        <>
            {/*Início da div que contém a imagem do calendário*/}
            <div className="calendarioimg" onClick={handleShow} > {/*onClick permite abrir o todolist*/}
                <img src="./image/img_calen.png" alt="" />
            </div>
            {/*Fim da div*/}
