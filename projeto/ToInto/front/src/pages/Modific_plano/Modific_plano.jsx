    ...
    return (
        <section className="planos" id="plano">
            <div className="plano_free">
                ...
                <Link to="/cadastro/free" className="btn_1" id="mdfc_planofree">Modificar Agora</Link>
            </div>
            <div className="plano_mensal">
                ...
                <Link to="/cadastro/mensal" className="btn_2" id="mdfc_planomensal">Modificar Agora</Link>
            </div>
            <div className="plano_anual">
                ...
                <Link to="/cadastro/anual" className="btn_3" id="mdfc_planoanual">Modificar Agora</Link>
            </div>
        </section>
    );
}
