    ...
    return (
        <>
            ...
            <section className='todolist' show={show} onHide={handleClose}>
                <header className='inicio' closeButton  >
                    {/*div que contém a data fixa*/}
                    <div className="data" >
                        <h1 className='dia-mes'>13/09</h1>
                        <p className='dia-senama'>Quarta-feira</p>
                    </div>
                </header>
                ...
                <div className='corpo'>
                    ...
                    <form className="form-todo" controlId="exampleForm.ControlInput1">
